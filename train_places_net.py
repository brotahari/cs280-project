...
#     n.data = data
#     conv_kwargs = dict(param=param, train=train)
#     n.conv1, n.relu1 = conv_relu(n.data, 16, 96, stride=6, **conv_kwargs)

#     n.pool1 = max_pool(n.relu1, 3, stride=2, train=train)

#     n.fc2, n.relu2 = fc_relu(n.pool1, 1024, param=param)

#     n.fc3, n.relu3 = fc_relu(n.relu2, 1024, param=param)

#     n.drop3 = L.Dropout(n.relu3, in_place=True)

#     preds = n.fc4 = L.InnerProduct(n.drop3, num_output=num_classes, param=param)

#     if not train:
#         # Compute the per-label probabilities at test/inference time.
#         preds = n.probs = L.Softmax(n.fc4)
#     if with_labels:
#         n.label = labels
